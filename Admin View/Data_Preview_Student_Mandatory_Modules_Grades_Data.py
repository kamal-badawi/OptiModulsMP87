def run_data_preview_student_mandatory_modules_grades_data(language_index, data_type):
    ...
    data = get_sql_data('Student Mandatory Modules Grades Database',
                        'mandatory_modules_grades_data')
